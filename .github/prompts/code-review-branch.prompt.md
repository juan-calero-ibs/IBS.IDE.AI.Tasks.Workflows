...
Save findings to `.github/reviews/code-review-branch-<reviewed branch or revision range, or na>-<YYYY-MM-DD>.md`. Ask the user before creating or overwriting the file. At the top of the markdown file, include a `Review metadata` section with these fields in this order:

- `Date: YYYY-MM-DD`
- `branchName: <reviewed branch or revision range, or n/a>`
- `commitHash: <resolved commit hash for the reviewed tip/range, or n/a>`
- `stagedCommit: n/a`
